...
class KelasController extends Controller
{
    ...
    public function kelolaKelas(){
        ...
        $crud->setTable('kelas');
        $crud->setSubject('Kelas', 'Kelas');
        $crud->columns(['kode_kelas','nama_kelas']);
        
        $crud->addFields(['kode_kelas','nama_kelas']);
        $crud->editFields(['kode_kelas','nama_kelas']);
        $crud->requiredFields(['kode_kelas','nama_kelas']);
        ...
        //     return $data;
        // });
        $crud->callbackEditField('kode_kelas',function ($value, $row){
            return "<input type='text' id='kode_kelas' name='kode_kelas' class='form-control' value='".$value."' disabled>";
        });
