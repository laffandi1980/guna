...
class SiswaController extends Controller
{
    ...
    public function kelolasiswa(){
        ...
        $crud->addFields(['nis','nama','kode_kelas','kode_jurusan','jkel','agama','alamat','tgl_lahir','tmpt_lahir','phone','siswa_email','siswa_password','verifikasi_kode']);
        $crud->editFields(['nis','nama','kode_kelas','kode_jurusan','jkel','agama','alamat','tgl_lahir','tmpt_lahir','phone','siswa_email','siswa_password','verifikasi_kode']);
        $crud->requiredFields(['nis','nama','kode_kelas','kode_jurusan','jkel','agama','alamat','tgl_lahir','tmpt_lahir','phone','siswa_email','siswa_password','verifikasi_kode']);
